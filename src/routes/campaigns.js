...
router.post("/:id/donations", validate(donateSchema), asyncHandler(campaignController.donate));
...
router.post("/:id/milestones/:index/evaluations", validate(scoreMilestoneSchema), asyncHandler(campaignController.scoreMilestone));
